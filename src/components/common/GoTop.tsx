...
const GoToTop = () => {
  ...
  return (
    <div className='fixed bottom-12 left-0 w-screen block'>
      <div
        id='button'
        className='mr-2 xl:mr-8  ml-auto w-12 h-12 pt-2.5 rounded-full border-2 border-stone-400 dark:border-slate-200 bg-stone-100 dark:bg-slate-700 shadow-md opacity-50 hover:opacity-100 cursor-pointer transition-opacity ease-linear'
