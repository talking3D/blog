...
<figcaption>Jak widzisz dostrajanie modelu to sztuka szukania kompromisu (ang. <em>trade-off</em>). Choć na początku wydawało się, że idealny model to taki, który doskonale potrafi przewidywać wartości, zobaczyliśmy jak dalekie od oczekiwań takie rozumowanie potrafi być.</figcaption>
